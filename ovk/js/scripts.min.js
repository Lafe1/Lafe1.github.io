...
$(".mouse-icon").click(function() {     //так задается функция для элементов, созданных динамически в js
	$("html, body").animate({
		scrollTop: $(".s-wide").offset().top
	}, 1000);
});

$("body").on("click", ".top", function(){     //так задается функция для элементов, созданных динамически в js
	$("html, body").animate({
		scrollTop : 0,
	}, "slow");
});
...
customMfpGallery('.mfp-galary');
customMfpGallery('.mfp-certificate');

function customMfpGallery(classOfMfpGallery) {
...
function height() {
	...
	$(".s-reviews .desc").height('auto').equalHeights();
	$(".s-reviews .review-head-wrap").height('auto').equalHeights();
};
