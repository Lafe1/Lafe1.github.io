<header class="header">
	...
	<div>
		...
		<div class="header__aut-reg-wrapper">
			<a href="" class="header__authorization">Авторизация</a>
			<span>/</span>
			<a href="" class="header__registration">Регистрация</a>
		</div>
	</div>
	<?php
		else:
	?>
	<div>
	<div class="header__profile-wrapper"><a href="profile.php"><img src="img/profile.svg" alt="cup"></a></div>
		<div class="header__aut-reg-wrapper">
			<a href="database/exit.php" class="header__exit">Выйти</a>
		</div>
	</div>
	<?php
		endif;
